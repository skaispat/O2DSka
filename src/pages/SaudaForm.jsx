...
const SaudaForm = () => {
  ...
  const postToGoogleSheet = async (data) => {
    try {
      ...
      const rowData = [
        ...
        "",              // Empty (column M)
        "Pending",       // Completed (column N) - default to "Pending"
        "",              // Empty (column O)
  ...
  const handleAddNewParty = async () => {
    if (formData.partyName && formData.partyName.trim() && !partyOptions.includes(formData.partyName.trim())) {
  ...
  const handleAddNewBrand = async () => {
    if (formData.brandName && formData.brandName.trim() && !brandOptions.includes(formData.brandName.trim())) {
