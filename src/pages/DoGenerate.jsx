...
import { Plus, X, Filter, Search, RefreshCw } from "lucide-react";
...
const DoGenerate = () => {
  ...
  const getTransporterNames = (sheetData) => {
    ...
    return sheetData
      .slice(1)
      .map((row) => row[5]) // Extract the 6th column ("Transporter Name")
  ...
  const fetchMainMasterData = async () => {
    try {
      const res = await fetch(
        "https://script.google.com/macros/s/AKfycbyhWN2S6qnJm7RVQr5VpPfyKRxI8gks0xxgWh_reMVlpsWvLo0rfzvqVA34x2xkPsJm/exec?sheetId=1wbIPdsHBxTE7fnzgOiAxS4koFwNxzwdpgp59NRWsnoc&sheetName=Main%20Master"
      );
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <select
                  ...
                  className="mb-4 border border-gray-300 px-4 py-2 rounded"
                >
