...
//             <select
//               className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none pr-8"
//               value=""
//               onChange={(e) => {
//                 if (e.target.value) {
...
//                   {visibleColumns.includes(column.value) ? '✓ ' : ''}{column.label}
//                 </option>
//               ))}
//             </select>
