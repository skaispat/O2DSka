...
//               <h2 className="text-xl font-bold">Loading 2nd Details</h2>
//             </div>
...
//                   value="complete"
//                   disabled
//                   className="w-full border border-gray-300 rounded-md px-2 py-2 text-sm bg-gray-100 cursor-not-allowed focus:outline-none"
//                 >
