...
//           planned1: row[20], // Column T - Planned1
//           actual1: row[21], // Column U - Actual1
//           status: row[23], // Column W - Status
//         }));
...
//             sheetId: "1-XC_skvApVDymxDm8O2CtImaDEAnEtChKekT2URbj1E",
//             sheetName: "INVOICE-DELIVERY",
//             action: "update",
//             rowIndex: currentItem.id + 6,
//             columnData: JSON.stringify({
//               V: `'${currentDateTime}`, // Column U - Actual1 (autofill current date)
//               X: status, // Column W - Status
//             }),
//           }),
//         }
//       );
...
import React, { useState, useEffect } from "react";
import { Filter, Search, Clock, CheckCircle, RefreshCw, Columns } from "lucide-react";
import useAuthStore from "../store/authStore";
import toast from "react-hot-toast";
              ...
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                <div className="p-2 max-h-60 overflow-y-auto">
                  {columnOptions.map((column) => (
                    <div key={column.id} className="flex items-center p-2 hover:bg-gray-50">
                      <input
                        type="checkbox"
                        id={column.id}
                      ...
                      />
                      <label htmlFor={column.id} className="ml-2 text-sm text-gray-700">
                        {column.label}
                      </label>
                    </div>
                  ))}
