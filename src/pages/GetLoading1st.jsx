...
import { Filter, Search, Clock, CheckCircle, Columns, X } from "lucide-react";
...
const GetLoading1st = () => {
    ...
    try {
      ...
      if (data) {
        const allData = data.map((row, index) => ({
          ...
          planned3: row.planned3 || row.planned_date_3,
          actual3: row.actual3 || row.actual_date_3,
          loadingStatus1: row.loading_status,
  ...
  hour12: false 
    ...
    try {
      const updateData = {
        loading_status: currentItem?.loadingStatus1 || "complete",
        // planned5: new Date().toISOString(),
      };

      if (currentItem?.loadingStatus1 === "complete" || !currentItem?.loadingStatus1) {
        updateData.actual3 = currentDateTime;
      }
    ...
    <div className="bg-white rounded-lg shadow border border-gray-200 p-4 mb-4">
      <div className="flex justify-between items-start mb-3">
        ...
        <span className={`px-2 py-1 text-xs rounded-full ${
          ...
          {item.loadingStatus1 === "complete" ? "Complete" : "Pending"}
        </span>
      </div>
  ...
  return (
    <div className="space-y-4 md:space-y-6 p-2 md:p-0">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gray-50 px-4 md:px-6 py-4 flex justify-end space-x-3 sticky bottom-0">
              ...
              <button
                ...
                className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors disabled:opacity-50 flex items-center justify-center min-w-[120px] text-sm md:text-base"
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-xl md:text-2xl font-bold text-gray-800">Get Loading 1st</h1>
      </div>
